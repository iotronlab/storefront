<template>
  <v-container>
      ...
      >
        <v-row no-gutters class="fill-height" justify="end" align="end">
          <div>
            <v-btn class="ma-2" color="primary"
              ><v-icon>mdi-hearts-outline</v-icon>Follow</v-btn
            >
          </div>
        </v-row>
      </v-img>
    ...
    <v-card class="pa-2">
      <v-avatar rounded class="profile mt-n12" color="grey" size="164">
        <v-img
