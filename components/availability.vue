                            ...
                            >
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        ...
                                        <v-list-item-subtitle>Rate: {{service.rate}}</v-list-item-subtitle>
                                        <v-list-item-subtitle>ETD: {{service.etd}}</v-list-item-subtitle>
                                        <v-list-item-subtitle>Estimated: {{service.estimated_delivery_days}} days</v-list-item-subtitle>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card>
                        </v-scale-transition>
...
export default {
    ...
    methods: {     
        ...
        getDetails(){
            this.$axios.get(`https://apiv2.shiprocket.in/v1/external/courier/serviceability/?pickup_postcode=${this.pincode1}&delivery_postcode=${this.pincode2}&weight=1&cod=${this.cod}`, 
            {
                headers: {
                    'Authorization': `Bearer ${this.token}`,
                    'Content-Type': 'application/json'
